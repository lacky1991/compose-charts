...
internal object LineChartUtils {
    ...
    fun calculateDrawableArea(
        ...
        val horizontalOffset = xAxisDrawableArea.width * offset
        return Rect(
    ...
    fun Density.calculateYAxisDrawableArea(
        ...
        return Rect(
            left = 0f,
            top = 0f,
            bottom = if (xAxisLabelSize == 0f) 0f else size.height - xAxisLabelSize,
            right = if (xAxisLabelSize == 0f) 0f else right
        )
    }
